...
namespace ProAFSolutionsAPI.Templates
{
    public class TemplatesConst
    {
        public const string EMAIL_WELCOME = "";
        public const string EMAIL_CHAT_CONVERSATION = "email-conversation-template.html";
        public const string EMAIL_OFFER_STORE = "email-offer-package-store.html";
        public const string EMAIL_OFFER_WEB_APP = "email-offer-package-web-app.html";
